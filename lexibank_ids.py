...
class Dataset(IDSDataset):
    ...
    def cmd_makecldf(self, args):
        ...
        iso_codes = {lg.id.strip(): lg.sil_code.strip() for lg in self.ids_raw_read("sil_lang")}
        iso_codes = {
            lg.lg_id.strip(): iso_codes[lg.sil_id.strip()] for lg in self.ids_raw_read("x_lg_sil")
        }
